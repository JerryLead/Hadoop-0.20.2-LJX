...
<%
  for (JobHistory.TaskAttempt attempt : task.getTaskAttempts().values()) {
    printTaskAttempt(attempt, type, out, jobid);
  }
%>
</table>
</center>
...
<%!
  private void printTaskAttempt(JobHistory.TaskAttempt taskAttempt,
                                String type, JspWriter out, String jobid) 
  throws IOException {
	...
	String taskPerUrl =  hostAndPort + "/taskPerf.jsp?jobid=" + jobid + "&taskid=" + taskAttempt.get(Keys.TASK_ATTEMPT_ID);
    out.print("<tr>"); 
